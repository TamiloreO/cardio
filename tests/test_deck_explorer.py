...
class TestDeckExplorerInit:
    ...
    def test_init_with_provided_screen(self, mock_screen):
        with patch('cardio.tui.deck_explorer.TUIBaseMixin.__init__', return_value=None):
    ...
    def test_init_always_calls_super_init(self, mock_screen):
        """Verify that super().__init__() is always called."""
        with patch('cardio.tui.deck_explorer.TUIBaseMixin.__init__') as mock_super_init:
...
class TestDeckExplorerClose:
    ...
    def test_close_does_not_close_borrowed_screen(self, mock_screen):
        with patch('cardio.tui.deck_explorer.TUIBaseMixin.__init__', return_value=None):
            with patch('cardio.tui.deck_explorer.TUIBaseMixin.close') as mock_super_close:
                from cardio.tui.deck_explorer import DeckExplorer
                ...
                # super().close() should NOT have been called since we borrowed the screen
